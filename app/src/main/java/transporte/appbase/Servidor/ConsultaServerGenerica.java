...
public  class ConsultaServerGenerica extends AsyncTask<HashMap<String, Object>, Void, InputStream> {
    ...
    protected ServidorCommand serverCommand;

    public ConsultaServerGenerica(ServidorCommand serverCommand) {
